...
<div id="box" class="card">
	...
	<h3>The Rate Change from  ${currencyConverterAttribute.convertCurrency} to ${currencyConverterAttribute.baseCurrency} is ${currencyConverterAttribute.rateChange}</h3>
</div>
</div>
</body>
